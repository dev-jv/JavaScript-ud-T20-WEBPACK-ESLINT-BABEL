...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"reiniciarObjeto\": () => /* binding */ reiniciarObjeto,\n/* harmony export */   \"datosCita\": () => /* binding */ datosCita,\n/* harmony export */   \"nuevaCita\": () => /* binding */ nuevaCita,\n/* harmony export */   \"eliminarCita\": () => /* binding */ eliminarCita,\n/* harmony export */   \"cargarEdicion\": () => /* binding */ cargarEdicion\n/* harmony export */ });\n/* harmony import */ var _classes_Citas__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./classes/Citas */ \"./js/classes/Citas.js\");\n/* harmony import */ var _classes_UI__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./classes/UI */ \"./js/classes/UI.js\");\n/* harmony import */ var _selectores__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./selectores */ \"./js/selectores.js\");\nfunction ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); if (enumerableOnly) symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); keys.push.apply(keys, symbols); } return keys; }\n\nfunction _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(Object(source), true).forEach(function (key) { _defineProperty(target, key, source[key]); }); } else if (Object.getOwnPropertyDescriptors) { Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)); } else { ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\n // eslint-disable-next-line import/no-cycle\n\n\n\nvar administrarCitas = new _classes_Citas__WEBPACK_IMPORTED_MODULE_2__.default();\nvar ui = new _classes_UI__WEBPACK_IMPORTED_MODULE_0__.default(administrarCitas);\nvar editando = false;\nvar citaObj = {\n  mascota: '',\n  propietario: '',\n  telefono: '',\n  fecha: '',\n  hora: '',\n  sintomas: ''\n};\nfunction reiniciarObjeto() {\n  // Reiniciar el objeto\n  citaObj.mascota = '';\n  citaObj.propietario = '';\n  citaObj.telefono = '';\n  citaObj.fecha = '';\n  citaObj.hora = '';\n  citaObj.sintomas = '';\n}\nfunction datosCita(e) {\n  //  console.log(e.target.name) // Obtener el Input\n  citaObj[e.target.name] = e.target.value;\n}\nfunction nuevaCita(e) {\n  e.preventDefault();\n  var mascota = citaObj.mascota,\n      propietario = citaObj.propietario,\n      telefono = citaObj.telefono,\n      fecha = citaObj.fecha,\n      hora = citaObj.hora,\n      sintomas = citaObj.sintomas; // Validar\n\n  if (mascota === '' || propietario === '' || telefono === '' || fecha === '' || hora === '' || sintomas === '') {\n    ui.imprimirAlerta('Todos los campos son Obligatorios', 'error');\n    return;\n  }\n\n  if (editando) {\n    // Estamos editando\n    administrarCitas.editarCita(_objectSpread({}, citaObj));\n    ui.imprimirAlerta('Guardado Correctamente');\n    _selectores__WEBPACK_IMPORTED_MODULE_1__.formulario.querySelector('button[type=\"submit\"]').textContent = 'Crear Cita';\n    editando = false;\n  } else {\n    // Nuevo Registrando\n    // Generar un ID único\n    citaObj.id = Date.now(); // Añade la nueva cita\n\n    administrarCitas.agregarCita(_objectSpread({}, citaObj)); // Mostrar mensaje de que todo esta bien...\n\n    ui.imprimirAlerta('Se agregó correctamente');\n  } // Imprimir el HTML de citas\n\n\n  ui.imprimirCitas(administrarCitas); // Reinicia el objeto para evitar futuros problemas de validación\n\n  reiniciarObjeto(); // Reiniciar Formulario\n\n  _selectores__WEBPACK_IMPORTED_MODULE_1__.formulario.reset();\n}\nfunction eliminarCita(id) {\n  administrarCitas.eliminarCita(id);\n  ui.imprimirCitas(administrarCitas);\n}\nfunction cargarEdicion(cita) {\n  var mascota = cita.mascota,\n      propietario = cita.propietario,\n      telefono = cita.telefono,\n      fecha = cita.fecha,\n      hora = cita.hora,\n      sintomas = cita.sintomas,\n      id = cita.id; // Reiniciar el objeto\n\n  citaObj.mascota = mascota;\n  citaObj.propietario = propietario;\n  citaObj.telefono = telefono;\n  citaObj.fecha = fecha;\n  citaObj.hora = hora;\n  citaObj.sintomas = sintomas;\n  citaObj.id = id; // Llenar los Inputs\n\n  _selectores__WEBPACK_IMPORTED_MODULE_1__.mascotaInput.value = mascota;\n  _selectores__WEBPACK_IMPORTED_MODULE_1__.propietarioInput.value = propietario;\n  _selectores__WEBPACK_IMPORTED_MODULE_1__.telefonoInput.value = telefono;\n  _selectores__WEBPACK_IMPORTED_MODULE_1__.fechaInput.value = fecha;\n  _selectores__WEBPACK_IMPORTED_MODULE_1__.horaInput.value = hora;\n  _selectores__WEBPACK_IMPORTED_MODULE_1__.sintomasInput.value = sintomas;\n  _selectores__WEBPACK_IMPORTED_MODULE_1__.formulario.querySelector('button[type=\"submit\"]').textContent = 'Guardar Cambios';\n  editando = true;\n}\n\n//# sourceURL=webpack://webpack-eslint-babel/./js/funciones.js?");
